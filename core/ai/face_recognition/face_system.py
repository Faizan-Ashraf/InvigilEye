...
class Attendance:
    def __init__(self, csvFilePath):
        ...
        self.loadFaces()
        self.markedRegs = set()
        os.makedirs("attendance_snapshots", exist_ok=True)
        ...
        while True:
            ...
            for (top,right, bottom, left), face_encoding in zip(face_locations, face_encodings):
                ...
                if name=='UNKNOWN':
                    ...
                    file_path = f"attendance_snapshots/Unknown_{time_str}.jpg"
